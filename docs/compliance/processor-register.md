...
| Kit | Newsletter subscription and email delivery | Email address, subscription/consent evidence, delivery and engagement data | Delete when no longer needed; a suppression record may remain after unsubscribe | Active; future blog posts create review-only drafts through the V4 API; double opt-in verification remains pending |
