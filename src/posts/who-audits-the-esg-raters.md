---
title: "Who Audits the Raters: The EU Just Put ESG Scores Under Supervision"
...
The mechanics are worth knowing, because the deadlines are close.
...
I have written before about [why ESG reporting struggled for so long](/blog/from-guesswork-to-audit-trails/): not because the numbers were impossible to calculate, but because organisations could not always show where a figure came from. The reporting side has spent several hard years fixing that. Source documents got attached to figures. Assumptions got written down with a name and a date next to them.
...
> A rating is only as defensible as the process that produced it, and until now, very little of that process had to be shown to anyone.
